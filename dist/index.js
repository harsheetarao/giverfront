...
__export(components_exports, {
    BulkPartnerPickupRequestForm: function() {
        return BulkPartnerPickupRequestForm;
    },
    Button: function() {
        return Button;
    },
    ...
    DriverPickupWorkflow: function() {
        return DriverPickupWorkflow;
    },
    DropoffRequestManager: function() {
        return DropoffRequestManager;
    },
    Footer: function() {
        return Footer;
    },
    ...
    ListingWorkflow: function() {
        return ListingWorkflow;
    },
    LogisticsCalendar: function() {
    ...
    PartnerPickupRequestForm: function() {
        return PartnerPickupRequestForm;
    },
    PickupList: function() {
        return PickupList;
    },
...
var buttonVariants2 = (0, import_class_variance_authority2.cva)("flex items-center justify-center text-base font-poppins rounded-md transition-colors duration-200 ease-in-out px-4 py-2 disabled:opacity-50 disabled:cursor-not-allowed", {
    variants: {
        variant: {
...
var stateStyles = {
    ...
    completed: {
        border: "border-[#5A7C6F]",
        text: "text-[#5A7C6F]",
        icon: /* @__PURE__ */ import_react3.default.createElement(import_lucide_react.Check, {
    ...
    error: {
        ...
        text: "text-red-500",
        icon: /* @__PURE__ */ import_react3.default.createElement(import_lucide_react.X, {
            className: "h-3 w-3 text-white"
        }),
        iconBg: "bg-red-500"
    },
    ...
    blankRequired: {
        ...
        text: "text-[#5A7C6F]",
        icon: /* @__PURE__ */ import_react3.default.createElement(import_lucide_react.AlertCircle, {
            className: "h-3 w-3 text-white"
        }),
        iconBg: "bg-[#ED933F]"
    },
...
var FormDropdown = import_react3.default.forwardRef(function(_param, ref) {
    ...
    var _ref = _sliced_to_array((0, import_react3.useState)(false), 2), isOpen = _ref[0], setIsOpen = _ref[1];
    var dropdownRef = (0, import_react3.useRef)(null);
    ...
    }, (selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.label) || "Select an option", /* @__PURE__ */ import_react3.default.createElement(import_lucide_react.ChevronDown, {
        className: cn("absolute right-3 top-1/2 -translate-y-1/2 h-5 w-5", "text-[#5A7C6F]/60", isOpen && "transform rotate-180")
    })), isOpen && /* @__PURE__ */ import_react3.default.createElement("div", {
    ...
    }, styles.icon)), hint && /* @__PURE__ */ import_react3.default.createElement("p", {
...
var ImageUpload = function(param) {
    ...
    var uniqueId = (0, import_react5.useId)();
    var inputId = "photo-upload-".concat(uniqueId);
    var _ref = _sliced_to_array((0, import_react5.useState)(false), 2), isDragging = _ref[0], setIsDragging = _ref[1];
    var handleFiles = (0, import_react5.useCallback)(function(files) {
    ...
    var handleDrop = (0, import_react5.useCallback)(function(e) {
        e.preventDefault();
        setIsDragging(false);
    ...
    var handleDragOver = (0, import_react5.useCallback)(function(e) {
        e.preventDefault();
        setIsDragging(true);
    }, []);
    var handleDragLeave = (0, import_react5.useCallback)(function(e) {
        e.preventDefault();
        setIsDragging(false);
    }, []);
    ...
    }, /* @__PURE__ */ import_react5.default.createElement(import_lucide_react3.Upload, {
    ...
    }, "Drop photos here or click to upload"), /* @__PURE__ */ import_react5.default.createElement("p", {
        className: "text-sm text-[#5A7C6F]"
    }, "Upload clear photos (max ", maxFiles, " files)"), /* @__PURE__ */ import_react5.default.createElement("p", {
...
var Tag = function(param) {
    ...
    }, onDelete && /* @__PURE__ */ import_react6.default.createElement("div", {
...
var ListingWorkflow = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react7.useState)(null), 2), selectedItem = _ref[0], setSelectedItem = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react7.useState)([]), 2), processingPhotos = _ref1[0], setProcessingPhotos = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react7.useState)({
        title: "",
        description: "",
        condition: "",
        dimensions: {
    ...
    var _ref3 = _sliced_to_array((0, import_react7.useState)(""), 2), newAttribute = _ref3[0], setNewAttribute = _ref3[1];
    ...
    if (!selectedItem) {
        return /* @__PURE__ */ import_react7.default.createElement("div", {
        ...
        }, "Items Pending Listing (", items.length, ")"), /* @__PURE__ */ import_react7.default.createElement("div", {
            className: "space-y-4"
            ...
            }, "Product ID: ", item.productId), /* @__PURE__ */ import_react7.default.createElement("span", {
                className: "text-sm text-gray-500"
            }, "Received: ", new Date(item.receivedDate).toLocaleDateString())), /* @__PURE__ */ import_react7.default.createElement("p", {
                className: "text-sm text-gray-600 mt-1"
            }, item.pickupDescription), /* @__PURE__ */ import_react7.default.createElement("p", {
    ...
    return /* @__PURE__ */ import_react7.default.createElement("div", {
    ...
    }, "\u2190 Back to List"), /* @__PURE__ */ import_react7.default.createElement(Card, {
        ...
        className: "font-rockwell text-lg text-[#4B7163]"
    }, "Item ID: ", selectedItem.productId)), /* @__PURE__ */ import_react7.default.createElement(Tag, {
        text: selectedItem.status,
        variant: "primary"
    })), /* @__PURE__ */ import_react7.default.createElement(ImageUpload, {
        ...
        variant: "secondary",
        className: "mt-6"
    }, "Add")), /* @__PURE__ */ import_react7.default.createElement("div", {
        ...
        return /* @__PURE__ */ import_react7.default.createElement(Tag, {
            key: index,
            text: attr,
            onDelete: function() {
    ...
    })))), /* @__PURE__ */ import_react7.default.createElement(FormDropdown, {
        label: "Category",
        options: [
            {
                value: "furniture",
        ...
        variant: "secondary",
        className: "flex items-center gap-2"
    }, /* @__PURE__ */ import_react7.default.createElement(import_lucide_react5.Save, {
        className: "h-4 w-4"
    }), "Save Draft"), /* @__PURE__ */ import_react7.default.createElement(CustomButton, {
        onClick: handleSubmit,
        variant: "cta",
        disabled: !isFormValid(),
        className: "flex items-center gap-2"
    }, /* @__PURE__ */ import_react7.default.createElement(import_lucide_react5.Send, {
        className: "h-4 w-4"
    }), "Mark Ready for Sale")))));
};
...
var InventoryProcessing = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react8.useState)(""), 2), productId = _ref[0], setProductId = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react8.useState)(""), 2), description = _ref1[0], setDescription = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react8.useState)([]), 2), processingPhotos = _ref2[0], setProcessingPhotos = _ref2[1];
...
var Modal = function(param) {
    ...
    }, /* @__PURE__ */ import_react9.default.createElement(import_lucide_react6.X, {
        className: "h-6 w-6"
    })), children));
};
// src/components/MapModal.tsx
...
var MapModal = function(param) {
    ...
    return /* @__PURE__ */ import_react10.default.createElement(Modal, {
        onClose: onClose
    }, /* @__PURE__ */ import_react10.default.createElement("div", {
        className: "p-6"
    }, /* @__PURE__ */ import_react10.default.createElement("h2", {
        className: "font-rockwell text-2xl text-[#4B7163] mb-4"
    }, "Pickup Location"), /* @__PURE__ */ import_react10.default.createElement("div", {
        className: "mb-6"
    }, /* @__PURE__ */ import_react10.default.createElement("div", {
        className: "flex items-center gap-2 text-[#5A7C6F] mb-4"
    }, /* @__PURE__ */ import_react10.default.createElement(import_lucide_react7.MapPin, {
        className: "h-4 w-4 flex-shrink-0"
    }), /* @__PURE__ */ import_react10.default.createElement("p", null, address)), /* @__PURE__ */ import_react10.default.createElement("div", {
    ...
    })), /* @__PURE__ */ import_react10.default.createElement(CustomButton, {
        onClick: openInGoogleMaps,
        className: "w-full flex items-center justify-center gap-2"
    }, /* @__PURE__ */ import_react10.default.createElement(import_lucide_react7.Navigation, {
        className: "w-4 h-4"
    }), "Get Directions")), /* @__PURE__ */ import_react10.default.createElement("p", {
        className: "text-sm text-[#5A7C6F]"
...
var MessageThread = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react12.useState)(false), 2), isExpanded = _ref[0], setIsExpanded = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react12.useState)(""), 2), newMessage = _ref1[0], setNewMessage = _ref1[1];
    ...
    return /* @__PURE__ */ import_react12.default.createElement("div", {
    ...
    }, /* @__PURE__ */ import_react12.default.createElement(import_lucide_react8.MessageCircle, {
        className: "h-5 w-5 text-[#4B7163]"
    }), /* @__PURE__ */ import_react12.default.createElement("span", {
        className: "font-medium text-[#4B7163]"
    }, "Messages"), unreadCount > 0 && /* @__PURE__ */ import_react12.default.createElement("span", {
        className: "bg-[#6AB098] text-white text-sm px-2 py-1 rounded-full"
    }, unreadCount, " new")), lastMessage && /* @__PURE__ */ import_react12.default.createElement("span", {
        className: "text-sm text-gray-500"
    }, "Last message ", lastMessageTime)), isExpanded && /* @__PURE__ */ import_react12.default.createElement("div", {
        className: "mt-4 space-y-4"
    }, messages.map(function(message, index) {
        return /* @__PURE__ */ import_react12.default.createElement("div", {
            key: message.id
        }, /* @__PURE__ */ import_react12.default.createElement(MessageBubble, {
        ...
        }, /* @__PURE__ */ import_react12.default.createElement("p", null, message.content), /* @__PURE__ */ import_react12.default.createElement("span", {
            className: "text-sm opacity-75 mt-2 block"
        }, message.timestamp.toLocaleString())));
    }), /* @__PURE__ */ import_react12.default.createElement("form", {
        onSubmit: function(e) {
            e.preventDefault();
            if (newMessage.trim()) {
    ...
    }), /* @__PURE__ */ import_react12.default.createElement(CustomButton, {
        type: "submit",
...
var SwipeCard = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react13.useState)(0), 2), exitX = _ref[0], setExitX = _ref[1];
    ...
    return /* @__PURE__ */ import_react13.default.createElement(import_framer_motion.motion.div, {
    ...
    }, children)), /* @__PURE__ */ import_react13.default.createElement(import_framer_motion.motion.div, {
        className: "absolute bottom-4 left-0 right-0 flex justify-center gap-4",
        style: {
            opacity: (0, import_framer_motion.useTransform)(x, [
                -50,
                0,
                50
            ], [
    ...
    }, /* @__PURE__ */ import_react13.default.createElement(import_lucide_react9.X, {
        className: "w-6 h-6 text-red-500"
    })), /* @__PURE__ */ import_react13.default.createElement("button", {
        onClick: handleAccept,
        className: "p-3 rounded-full bg-white shadow-lg hover:bg-gray-50"
    }, /* @__PURE__ */ import_react13.default.createElement(import_lucide_react9.Check, {
...
var ReceivingWorkflow = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react14.useState)(null), 2), selectedItem = _ref[0], setSelectedItem = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react14.useState)(null), 2), processingItem = _ref1[0], setProcessingItem = _ref1[1];
    ...
    if (processingItem) {
        return /* @__PURE__ */ import_react14.default.createElement("div", {
            className: className
        }, /* @__PURE__ */ import_react14.default.createElement(CustomButton, {
            variant: "secondary",
            onClick: function() {
                return setProcessingItem(null);
            },
            className: "mb-4"
        }, "\u2190 Back to List"), /* @__PURE__ */ import_react14.default.createElement(InventoryProcessing, {
            request: {
    ...
    return /* @__PURE__ */ import_react14.default.createElement("div", {
        className: cn("space-y-6", className)
    }, selectedItem ? /* @__PURE__ */ import_react14.default.createElement(import_react14.default.Fragment, null, /* @__PURE__ */ import_react14.default.createElement(CustomButton, {
        variant: "secondary",
        onClick: function() {
            return setSelectedItem(null);
        },
        className: "mb-4"
    }, "\u2190 Back to List"), /* @__PURE__ */ import_react14.default.createElement("div", {
        className: "aspect-[3/4] w-full relative"
    }, /* @__PURE__ */ import_react14.default.createElement("div", {
        className: "absolute inset-0 -mx-8"
    }, /* @__PURE__ */ import_react14.default.createElement("div", {
        className: "relative h-full mx-8"
    }, /* @__PURE__ */ import_react14.default.createElement(SwipeCard, {
    ...
    }, /* @__PURE__ */ import_react14.default.createElement("h4", {
        className: "font-semibold text-[#4B7163] mb-2"
    }, selectedItem.name), /* @__PURE__ */ import_react14.default.createElement("p", {
        className: "text-sm text-[#5A7C6F] mb-2"
    }, selectedItem.description), /* @__PURE__ */ import_react14.default.createElement("div", {
        className: "flex items-center gap-2"
    ...
    }, selectedItem.status.charAt(0).toUpperCase() + selectedItem.status.slice(1)))))))), /* @__PURE__ */ import_react14.default.createElement("div", {
        className: "flex justify-center gap-8 text-sm text-gray-500 mt-2"
    }, /* @__PURE__ */ import_react14.default.createElement("div", {
        className: "flex items-center gap-1"
    }, /* @__PURE__ */ import_react14.default.createElement(import_lucide_react10.X, {
        className: "h-4 w-4 text-red-500"
    }), " Swipe left to reject"), /* @__PURE__ */ import_react14.default.createElement("div", {
        className: "flex items-center gap-1"
    }, /* @__PURE__ */ import_react14.default.createElement(import_lucide_react10.Check, {
        className: "h-4 w-4 text-green-500"
    }), " Swipe right to receive"))) : /* @__PURE__ */ import_react14.default.createElement("div", {
        className: "bg-white rounded-2xl border-2 border-[#4B7163] p-6"
    }, /* @__PURE__ */ import_react14.default.createElement("h2", {
        className: "font-rockwell text-2xl text-[#4B7163] mb-6"
    }, "Pending Items (", pendingItems.length, ")"), /* @__PURE__ */ import_react14.default.createElement("div", {
        ...
        return /* @__PURE__ */ import_react14.default.createElement("div", {
            ...
            alt: item.name,
            className: "w-24 h-24 rounded-lg object-cover"
        }), /* @__PURE__ */ import_react14.default.createElement("div", null, /* @__PURE__ */ import_react14.default.createElement("h3", {
            className: "font-rockwell text-lg text-[#4B7163]"
        }, item.name), /* @__PURE__ */ import_react14.default.createElement("p", {
            className: "text-sm text-[#5A7C6F]"
        }, item.description)));
    }))));
};
...
var Progress = function(param) {
    ...
    return /* @__PURE__ */ import_react15.default.createElement("div", {
        ...
        }, isCompleted ? /* @__PURE__ */ import_react15.default.createElement(import_lucide_react11.Check, {
            className: "w-4 h-4 text-white"
        }) : /* @__PURE__ */ import_react15.default.createElement(StepIcon, {
        ...
        }, step.label), /* @__PURE__ */ import_react15.default.createElement("div", {
        ...
        }, step.description, /* @__PURE__ */ import_react15.default.createElement("div", {
...
var PlacesAutocomplete = function(param) {
    ...
    return /* @__PURE__ */ import_react16.default.createElement("div", {
        className: "relative"
    }, /* @__PURE__ */ import_react16.default.createElement(FormInput, {
    ...
    }), data.length > 0 && /* @__PURE__ */ import_react16.default.createElement("ul", {
...
var PickupRequestForm = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react16.useState)(function() {
        ...
        return 1;
    }), 2), currentStep = _ref[0], setCurrentStep = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react16.useState)(function() {
        if (typeof window !== "undefined") {
            var saved = localStorage.getItem("formData_items");
            return saved ? JSON.parse(saved) : [];
        }
        return [];
    }), 2), uploadedItems = _ref1[0], setUploadedItems = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react16.useState)(function() {
        if (typeof window !== "undefined") {
            var saved = localStorage.getItem("formData_times");
            return saved ? JSON.parse(saved) : [];
        }
        return [];
    }), 2), availableTimes = _ref2[0], setAvailableTimes = _ref2[1];
    var _ref3 = _sliced_to_array((0, import_react16.useState)(function() {
        if (typeof window !== "undefined") {
            return localStorage.getItem("formData_address") || "";
        }
        return "";
    }), 2), address = _ref3[0], setAddress = _ref3[1];
    var _ref4 = _sliced_to_array((0, import_react16.useState)(function() {
        if (typeof window !== "undefined") {
    ...
    var _ref5 = _sliced_to_array((0, import_react16.useState)(false), 2), showTerms = _ref5[0], setShowTerms = _ref5[1];
    var _ref6 = _sliced_to_array((0, import_react16.useState)({
        ownership: false,
        terms: false,
        liability: false,
        marketing: false
    }), 2), confirmations = _ref6[0], setConfirmations = _ref6[1];
    var _ref7 = _sliced_to_array((0, import_react16.useState)(""), 2), feedback = _ref7[0], setFeedback = _ref7[1];
    var _ref8 = _sliced_to_array((0, import_react16.useState)(false), 2), isTermsVisible = _ref8[0], setIsTermsVisible = _ref8[1];
    var _ref9 = _sliced_to_array((0, import_react16.useState)(false), 2), loading = _ref9[0], setLoading = _ref9[1];
    var _ref10 = _sliced_to_array((0, import_react16.useState)(""), 2), formMessage = _ref10[0], setFormMessage = _ref10[1];
    var _ref11 = _sliced_to_array((0, import_react16.useState)(false), 2), isPrivacyVisible = _ref11[0], setIsPrivacyVisible = _ref11[1];
    var _ref12 = _sliced_to_array((0, import_react16.useState)([]), 2), completedSteps = _ref12[0], setCompletedSteps = _ref12[1];
    var _ref13 = _sliced_to_array((0, import_react16.useState)(null), 2), requestId = _ref13[0], setRequestId = _ref13[1];
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        return [
                            4,
                            (0, import_firestore2.addDoc)((0, import_firestore2.collection)(db, "feedback"), feedbackData)
                        ];
                    case 1:
                        docRef = _state.sent();
    ...
    var renderStepContent = function() {
        ...
        switch(currentStep){
            case 1:
                return /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "space-y-6"
                }, !isStepCompleted(1) && /* @__PURE__ */ import_react16.default.createElement("div", {
                ...
                }, "Items We Accept"), /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-[#5A7C6F]"
                }, "We accept gently used furniture and home goods. All items must be in good condition, clean, and free from damage. Please ensure items are ready for pickup and easily accessible.")), /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "bg-[#F8FAF9] rounded-xl p-6"
                }, /* @__PURE__ */ import_react16.default.createElement(ImageUpload, {
                    ...
                    maxFiles: 50
                }), uploadedItems.length > 0 && /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "space-y-6"
                    ...
                    }, "\xD7"), /* @__PURE__ */ import_react16.default.createElement("img", {
                        src: item.imageUrl,
                        alt: "Item",
                        className: "w-full h-full object-cover"
                    }), item.status === "uploading" && /* @__PURE__ */ import_react16.default.createElement("div", {
                        className: "absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center"
                    }, /* @__PURE__ */ import_react16.default.createElement("div", {
                        className: "animate-spin rounded-full h-6 w-6 border-b-2 border-white"
                    })), item.status === "error" && /* @__PURE__ */ import_react16.default.createElement("div", {
                        className: "absolute inset-0 bg-red-500 bg-opacity-50 flex items-center justify-center"
                    }, /* @__PURE__ */ import_react16.default.createElement("span", {
                        className: "text-white text-sm"
                    }, "Error"))), /* @__PURE__ */ import_react16.default.createElement("div", {
                        className: "flex-grow"
                    }, /* @__PURE__ */ import_react16.default.createElement(FormInput, {
                        label: "Item Description",
            ...
            case 2:
                ...
                return /* @__PURE__ */ import_react16.default.createElement("div", {
                    ...
                    className: "font-rockwell text-lg text-[#4B7163] mb-2"
                }, "Schedule Your Pickup"), /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-[#5A7C6F]"
                }, "Please select at least two preferred pickup times. Having multiple options helps us plan the most efficient and sustainable pickup route, reducing our carbon footprint.")), /* @__PURE__ */ import_react16.default.createElement("div", {
                    ...
                    step: "1800",
                    list: "time-options"
                }), /* @__PURE__ */ import_react16.default.createElement("datalist", {
                    id: "time-options"
                }, generateTimeOptions().map(function(time) {
                    return /* @__PURE__ */ import_react16.default.createElement("option", {
                        key: time,
                        value: time
                    });
                }))), /* @__PURE__ */ import_react16.default.createElement("button", {
                ...
                }, "Add This Time Slot"), /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "mt-8"
                }, /* @__PURE__ */ import_react16.default.createElement("h4", {
                    className: "font-medium text-[#4B7163] mb-4"
                }, "Your Selected Time Slots ", availableTimes.length < 2 && /* @__PURE__ */ import_react16.default.createElement("span", {
                    className: "text-[#E67C45] text-sm"
                }, "(Please select ", 2 - availableTimes.length, " more)")), /* @__PURE__ */ import_react16.default.createElement("div", {
                    ...
                    }, "\xD7"), /* @__PURE__ */ import_react16.default.createElement("p", {
                        className: "text-[#4B7163] font-medium"
                    }, "Option ", index + 1), /* @__PURE__ */ import_react16.default.createElement("p", {
            ...
            case 3:
                ...
                return /* @__PURE__ */ import_react16.default.createElement("div", {
                    ...
                    className: "bg-[#F8FAF9] rounded-xl p-4"
                }, /* @__PURE__ */ import_react16.default.createElement(PlacesAutocomplete, {
                    value: address,
                    onChange: setAddress,
                ...
                }, /* @__PURE__ */ import_react16.default.createElement(import_lucide_react12.Info, {
                    className: "h-4 w-4"
                }), "Please ensure the address is accurate and items will be accessible at this location")), /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "space-y-4 bg-[#F8FAF9] rounded-xl p-4"
                }, /* @__PURE__ */ import_react16.default.createElement("h3", {
                    className: "font-rockwell text-lg text-[#4B7163] mb-4"
                }, "Final Confirmation"), /* @__PURE__ */ import_react16.default.createElement("label", {
                    ...
                    className: "text-sm text-[#5A7C6F]"
                }, "I am the owner of the household goods I am requesting for pick up.")), /* @__PURE__ */ import_react16.default.createElement("label", {
                    className: "flex items-start gap-3 cursor-pointer"
                }, /* @__PURE__ */ import_react16.default.createElement("input", {
                    type: "checkbox",
                    ...
                    className: "text-sm text-[#5A7C6F]"
                }, "I have read and agree to the", " ", /* @__PURE__ */ import_react16.default.createElement("button", {
                    type: "button",
                    onClick: function() {
                        return setIsTermsVisible(true);
                    },
                    className: "text-[#6AB098] underline hover:text-[#4B7163]"
                }, "Terms of Service"), " ", "and", " ", /* @__PURE__ */ import_react16.default.createElement("button", {
                    type: "button",
                    onClick: function() {
                        return setIsPrivacyVisible(true);
                    },
                    className: "text-[#6AB098] underline hover:text-[#4B7163]"
                }, "Privacy Policy"))), /* @__PURE__ */ import_react16.default.createElement("label", {
                    className: "flex items-start gap-3 cursor-pointer"
                }, /* @__PURE__ */ import_react16.default.createElement("input", {
                    type: "checkbox",
                    ...
                    className: "text-sm text-[#5A7C6F]"
                }, "I assume all risk associated with items being picked up at my residence and release Gone from any and all claims.")), /* @__PURE__ */ import_react16.default.createElement("label", {
                    className: "flex items-start gap-3 cursor-pointer"
                }, /* @__PURE__ */ import_react16.default.createElement("input", {
                    type: "checkbox",
            ...
            case 4:
                return /* @__PURE__ */ import_react16.default.createElement("div", {
                ...
                }, /* @__PURE__ */ import_react16.default.createElement(import_lucide_react12.CheckCircle2, {
                    className: "w-16 h-16 text-[#4B7163] mx-auto mb-4"
                }), /* @__PURE__ */ import_react16.default.createElement("h3", {
                    className: "font-rockwell text-2xl text-[#4B7163] mb-4"
                }, "Request Submitted Successfully!"), /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-[#5A7C6F] mb-6"
                }, "We'll review your request and get back to you via ", contactInfo.contact.includes("@") ? "email" : "text", " shortly. Thank you for being a sustainable citizen and giving your items a second life!")), requestId && /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "bg-[#F8FAF9] rounded-xl p-6"
                }, /* @__PURE__ */ import_react16.default.createElement("h4", {
                    className: "font-rockwell text-lg text-[#4B7163] mb-4"
                }, "Track Your Request Status"), /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-[#5A7C6F] mb-4"
                }, "You can check the status of your pickup request at any time:"), /* @__PURE__ */ import_react16.default.createElement("div", {
                ...
                }, "".concat(window.location.origin, "/pickup-status/").concat(requestId)), /* @__PURE__ */ import_react16.default.createElement("button", {
                    onClick: function() {
                ...
                }, "Copy Link"))), /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "bg-[#F8FAF9] rounded-xl p-6"
                }, /* @__PURE__ */ import_react16.default.createElement("h4", {
                    className: "font-rockwell text-lg text-[#4B7163] mb-4"
                }, "Your Pickup Request Details"), /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "space-y-4"
                }, /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "border-b border-[#4B7163]/10 pb-4"
                }, /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-sm text-[#5A7C6F] font-medium mb-2"
                }, "Contact Information"), /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "space-y-1"
                }, /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-[#4B7163]"
                }, contactInfo.fullName), /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-[#4B7163]"
                }, contactInfo.contact), /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-[#4B7163]"
                }, address))), /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "border-b border-[#4B7163]/10 pb-4"
                }, /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-sm text-[#5A7C6F] font-medium mb-2"
                }, "Items for Pickup (", uploadedItems.length, ")"), /* @__PURE__ */ import_react16.default.createElement("div", {
                    ...
                    }), /* @__PURE__ */ import_react16.default.createElement("div", null, /* @__PURE__ */ import_react16.default.createElement("p", {
                        className: "text-[#4B7163] font-medium"
                    }, item.description || "Item ".concat(index + 1)), item.quantity && item.quantity > 1 && /* @__PURE__ */ import_react16.default.createElement("p", {
                        className: "text-sm text-[#5A7C6F]"
                    }, "Quantity: ", item.quantity)));
                }))), /* @__PURE__ */ import_react16.default.createElement("div", null, /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-sm text-[#5A7C6F] font-medium mb-2"
                }, "Preferred Pickup Times"), /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "flex flex-wrap gap-2"
                    ...
                    className: "font-rockwell text-lg text-[#4B7163] mb-4"
                }, "How was your experience?"), /* @__PURE__ */ import_react16.default.createElement("textarea", {
                ...
                }), formMessage && /* @__PURE__ */ import_react16.default.createElement("p", {
                    className: "text-center text-sm text-[#4B7163] mt-2"
                }, formMessage)), /* @__PURE__ */ import_react16.default.createElement("div", {
                    className: "flex justify-center gap-4"
                }, /* @__PURE__ */ import_react16.default.createElement(CustomButton, {
                    onClick: handleNewRequest,
                    variant: "secondary"
                }, "Submit Another Request"), /* @__PURE__ */ import_react16.default.createElement(CustomButton, {
    ...
    var defaultSteps = [
        {
            ...
            icon: import_lucide_react12.Camera
        },
        {
            label: "Pickup Time",
            description: "Choose convenient pickup time slots",
            icon: import_lucide_react12.Calendar
        }
    ].concat(_to_consumable_array(skipConfirmationStep ? [] : [
        {
            ...
            icon: import_lucide_react12.UserCircle2
        }
    ]));
    var formSteps = steps || defaultSteps;
    return /* @__PURE__ */ import_react16.default.createElement("div", {
        className: cn("bg-white rounded-2xl border-2 border-[#4B7163] p-6 pt-8", className)
    }, !isSuccessStep() && /* @__PURE__ */ import_react16.default.createElement("div", {
        className: "mb-12"
    }, /* @__PURE__ */ import_react16.default.createElement(Progress, {
        ...
        className: "mb-8"
    }, currentStep === 4 ? /* @__PURE__ */ import_react16.default.createElement("div", {
        className: "flex items-center gap-3 mb-6"
    }, /* @__PURE__ */ import_react16.default.createElement("div", {
        className: "w-6 h-6 text-[#4B7163]"
    }, /* @__PURE__ */ import_react16.default.createElement(import_lucide_react12.CheckCircle2, null)), /* @__PURE__ */ import_react16.default.createElement("h2", {
        className: "font-rockwell text-2xl text-[#4B7163]"
    }, "Request Summary")) : formSteps[currentStep - 1] ? /* @__PURE__ */ import_react16.default.createElement(import_react16.default.Fragment, null, /* @__PURE__ */ import_react16.default.createElement("div", {
        className: "flex items-center gap-3 mb-6"
    }, formSteps[currentStep - 1].icon && /* @__PURE__ */ import_react16.default.createElement("div", {
        className: "w-6 h-6 text-[#4B7163]"
    }, import_react16.default.createElement(formSteps[currentStep - 1].icon)), /* @__PURE__ */ import_react16.default.createElement("h2", {
        className: "font-rockwell text-2xl text-[#4B7163]"
    }, formSteps[currentStep - 1].label)), /* @__PURE__ */ import_react16.default.createElement("p", {
        className: "text-gray-600 mb-6"
    }, formSteps[currentStep - 1].description)) : null, renderStepContent()), /* @__PURE__ */ import_react16.default.createElement("div", {
        className: "mt-8 flex justify-end"
    }, currentStep > 1 && !isSuccessStep() && /* @__PURE__ */ import_react16.default.createElement(CustomButton, {
        onClick: function() {
            return setCurrentStep(currentStep - 1);
        },
        variant: "secondary",
        className: "mr-auto"
    }, "Back"), /* @__PURE__ */ import_react16.default.createElement(CustomButton, {
        variant: "primary",
        className: "next-button",
        disabled: !canProceed() || isSubmitting || loading,
        onClick: handleNext
    }, isSubmitting || loading ? "Submitting..." : currentStep === 3 ? "Submit Request" : "Continue")), /* @__PURE__ */ import_react16.default.createElement(TermsOfService, {
        isVisible: isTermsVisible,
        onClose: function() {
            return setIsTermsVisible(false);
        }
    }), /* @__PURE__ */ import_react16.default.createElement(Privacy, {
...
var PickupRequestManager = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react17.useState)(0), 2), currentRequestIndex = _ref[0], setCurrentRequestIndex = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react17.useState)(pickupRequests[currentRequestIndex].items), 2), items = _ref1[0], setItems = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react17.useState)(""), 2), newMessage = _ref2[0], setNewMessage = _ref2[1];
    var _ref3 = _sliced_to_array((0, import_react17.useState)(false), 2), isMessagesExpanded = _ref3[0], setIsMessagesExpanded = _ref3[1];
    ...
    return /* @__PURE__ */ import_react17.default.createElement("div", {
    ...
    }, /* @__PURE__ */ import_react17.default.createElement(CustomButton, {
        onClick: function() {
        ...
        className: "font-rockwell text-2xl text-[#4B7163]"
    }, currentRequestIndex + 1, " of ", totalRequests), /* @__PURE__ */ import_react17.default.createElement(CustomButton, {
        onClick: function() {
            return setCurrentRequestIndex(function(prev) {
    ...
    }, "Items to Review (", pickupRequests[currentRequestIndex].items.length, ")"), /* @__PURE__ */ import_react17.default.createElement("div", {
        ...
        return /* @__PURE__ */ import_react17.default.createElement(SwipeCard, {
        ...
        }, item.description), /* @__PURE__ */ import_react17.default.createElement("div", {
            className: "space-y-2"
        }, /* @__PURE__ */ import_react17.default.createElement("div", {
            className: "flex items-center gap-2 text-[#5A7C6F]"
        }, /* @__PURE__ */ import_react17.default.createElement(import_lucide_react13.MapPin, {
            className: "h-4 w-4"
        }), /* @__PURE__ */ import_react17.default.createElement("span", {
            className: "text-sm"
        }, item.location)), /* @__PURE__ */ import_react17.default.createElement("div", {
            className: "flex items-center gap-2 text-[#5A7C6F]"
        }, /* @__PURE__ */ import_react17.default.createElement(import_lucide_react13.Calendar, {
            className: "h-4 w-4"
        }), /* @__PURE__ */ import_react17.default.createElement("div", {
            className: "text-sm"
            ...
            return /* @__PURE__ */ import_react17.default.createElement("span", {
                key: dateInfo.date
            }, idx > 0 && ", ", dateInfo.date, /* @__PURE__ */ import_react17.default.createElement("span", {
        ...
        className: "flex items-center gap-1"
    }, /* @__PURE__ */ import_react17.default.createElement(import_lucide_react13.X, {
        className: "h-4 w-4 text-red-500"
    }), " Swipe left to reject"), /* @__PURE__ */ import_react17.default.createElement("div", {
        className: "flex items-center gap-1"
    }, /* @__PURE__ */ import_react17.default.createElement(import_lucide_react13.Check, {
        className: "h-4 w-4 text-green-500"
    }), " Swipe right to accept")))), /* @__PURE__ */ import_react17.default.createElement(MessageThread, {
...
var ProductCard = function(param) {
    ...
    }, /* @__PURE__ */ import_react18.default.createElement("div", null, /* @__PURE__ */ import_react18.default.createElement("span", {
        className: "text-sm font-sourceSans text-[#5A7C6F] mb-1 block"
    }, category), /* @__PURE__ */ import_react18.default.createElement("h3", {
        className: "font-rockwell text-2xl text-[#4B7163]"
    }, title)), /* @__PURE__ */ import_react18.default.createElement("p", {
        className: "font-sourceSans text-gray-600 text-base"
    }, description), /* @__PURE__ */ import_react18.default.createElement("div", {
        className: "flex flex-wrap gap-2"
    }, attributes === null || attributes === void 0 ? void 0 : attributes.map(function(attr, index) {
        return /* @__PURE__ */ import_react18.default.createElement(Tag, {
            key: index,
            text: attr.label,
            variant: "secondary"
        });
    ...
    }, "$", price.toFixed(2)), /* @__PURE__ */ import_react18.default.createElement("span", {
        className: "font-sourceSans text-sm text-gray-500"
    }, "USD")), /* @__PURE__ */ import_react18.default.createElement(CustomButton, {
        onClick: onAddToCart,
        className: "flex items-center gap-2 px-6"
    }, /* @__PURE__ */ import_react18.default.createElement(import_lucide_react14.ShoppingCart, {
        className: "h-4 w-4"
    }), "Add to Cart"))));
};
...
var ShoppingCart2 = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react19.useState)(initialItems), 2), items = _ref[0], setItems = _ref[1];
    ...
    return /* @__PURE__ */ import_react19.default.createElement("div", {
        ...
        className: "font-rockwell text-2xl text-[#4B7163] mb-6"
    }, "Shopping Cart (", items.length, " ", items.length === 1 ? "item" : "items", ")"), items.length === 0 ? /* @__PURE__ */ import_react19.default.createElement("div", {
        className: "text-center py-8 text-gray-500 font-sourceSans"
    }, "Your cart is empty") : /* @__PURE__ */ import_react19.default.createElement(import_react19.default.Fragment, null, /* @__PURE__ */ import_react19.default.createElement("div", {
        ...
        }, /* @__PURE__ */ import_react19.default.createElement("div", null, /* @__PURE__ */ import_react19.default.createElement("h3", {
            className: "font-rockwell text-lg text-[#4B7163] mb-1"
        }, item.name), /* @__PURE__ */ import_react19.default.createElement("p", {
            className: "text-sm text-gray-600 font-sourceSans"
        }, item.description)), /* @__PURE__ */ import_react19.default.createElement("button", {
            onClick: function() {
                return onRemoveItem(item.id);
            },
            className: "text-gray-400 hover:text-gray-600 transition-colors p-1",
            "aria-label": "Remove ".concat(item.name, " from cart")
        }, /* @__PURE__ */ import_react19.default.createElement(import_lucide_react15.X, {
            className: "h-5 w-5"
        }))), /* @__PURE__ */ import_react19.default.createElement("div", {
    ...
    }, /* @__PURE__ */ import_react19.default.createElement("span", null, "Subtotal"), /* @__PURE__ */ import_react19.default.createElement("span", null, "$", subtotal.toFixed(2))), /* @__PURE__ */ import_react19.default.createElement("div", {
        className: "flex justify-between font-sourceSans text-[#5A7C6F]"
    }, /* @__PURE__ */ import_react19.default.createElement("span", null, "Tax (8.25%)"), /* @__PURE__ */ import_react19.default.createElement("span", null, "$", tax.toFixed(2))), /* @__PURE__ */ import_react19.default.createElement("div", {
        className: "border-t border-[#5A7C6F]/20 pt-3"
    }, /* @__PURE__ */ import_react19.default.createElement("div", {
        className: "flex justify-between font-rockwell text-xl text-[#4B7163]"
    }, /* @__PURE__ */ import_react19.default.createElement("span", null, "Total"), /* @__PURE__ */ import_react19.default.createElement("span", null, "$", total.toFixed(2))))), /* @__PURE__ */ import_react19.default.createElement(CustomButton, {
        onClick: onCheckout,
...
var SwipeCardDeck = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react20.useState)(cards), 2), currentCards = _ref[0], setCurrentCards = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react20.useState)([]), 2), history = _ref1[0], setHistory = _ref1[1];
    ...
    return /* @__PURE__ */ import_react20.default.createElement("div", {
        ...
        return /* @__PURE__ */ import_react20.default.createElement(SwipeCard, {
            key: card.id,
    ...
    })), history.length > 0 && /* @__PURE__ */ import_react20.default.createElement("button", {
...
var Toggle = function(param) {
    ...
    return /* @__PURE__ */ React24.createElement(import_framer_motion2.motion.button, {
        type: "button",
        role: "switch",
    ...
    }, /* @__PURE__ */ React24.createElement(import_framer_motion2.motion.span, {
...
var PartnerPickupRequestForm = function(props) {
    var _ref = _sliced_to_array((0, import_react21.useState)([]), 2), uploadedItems = _ref[0], setUploadedItems = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react21.useState)(""), 2), selectedDate = _ref1[0], setSelectedDate = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react21.useState)(""), 2), selectedTime = _ref2[0], setSelectedTime = _ref2[1];
    ...
    var defaultSteps = [
        {
            ...
            icon: import_lucide_react16.Camera
        },
        {
            label: "Drop-off Time",
            description: "Choose your preferred drop-off time",
            icon: import_lucide_react16.Calendar
        }
    ];
    var renderCustomStep = function(currentStep) {
        if (currentStep === 1) {
            return /* @__PURE__ */ import_react21.default.createElement("div", {
                ...
                className: "font-rockwell text-lg text-[#4B7163] mb-2"
            }, "Upload Photos of Your Items"), /* @__PURE__ */ import_react21.default.createElement("p", {
                className: "text-[#5A7C6F]"
            }, "Take clear photos of each item you plan to drop off. This helps us prepare the right space and resources.")), /* @__PURE__ */ import_react21.default.createElement("div", {
                className: "bg-[#F8FAF9] rounded-xl p-6"
            }, /* @__PURE__ */ import_react21.default.createElement(ImageUpload, {
                ...
                return /* @__PURE__ */ import_react21.default.createElement("div", {
                    ...
                    className: "flex-grow space-y-4"
                }, /* @__PURE__ */ import_react21.default.createElement(FormInput, {
                    label: "Item Description",
    ...
    var renderDetailsStep = function(uploadedItems2, handleItemDescription2, handleQuantityChange2) {
        return /* @__PURE__ */ import_react21.default.createElement("div", {
            ...
            className: "font-rockwell text-lg text-[#4B7163] mb-2"
        }, "Schedule Your Drop-off"), /* @__PURE__ */ import_react21.default.createElement("p", {
            className: "text-[#5A7C6F]"
        }, "Choose a convenient time to drop off your items.")), /* @__PURE__ */ import_react21.default.createElement("div", {
    ...
    return /* @__PURE__ */ import_react21.default.createElement(PickupRequestForm, _object_spread_props(_object_spread({
...
var BulkPartnerPickupRequestForm = function(props) {
    var _ref = _sliced_to_array((0, import_react22.useState)(null), 2), uploadMethod = _ref[0], setUploadMethod = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react22.useState)(null), 2), spreadsheet = _ref1[0], setSpreadsheet = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react22.useState)(null), 2), bulkPhotos = _ref2[0], setBulkPhotos = _ref2[1];
    var _ref3 = _sliced_to_array((0, import_react22.useState)(""), 2), dropOffDate = _ref3[0], setDropOffDate = _ref3[1];
    var _ref4 = _sliced_to_array((0, import_react22.useState)(""), 2), dropOffTime = _ref4[0], setDropOffTime = _ref4[1];
    var steps = [
        {
            label: "Upload Files",
            description: "Upload your inventory spreadsheet",
            icon: import_lucide_react17.FolderUp
        },
        {
            label: "Drop-off Time",
            description: "Choose your preferred drop-off time",
            icon: import_lucide_react17.Calendar
        }
    ];
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        return [
                            4,
                            (0, import_firestore3.addDoc)((0, import_firestore3.collection)(db, "pickupRequests"), formData)
                        ];
                    case 1:
                        docRef = _state.sent();
                        return [
    ...
    var renderCustomStep = function(currentStep) {
        if (currentStep === 1) {
            return /* @__PURE__ */ import_react22.default.createElement("div", {
                className: "space-y-6"
            }, !uploadMethod ? /* @__PURE__ */ import_react22.default.createElement("div", {
            ...
            }, /* @__PURE__ */ import_react22.default.createElement(import_lucide_react17.FolderUp, {
                className: "w-12 h-12 text-[#4B7163]"
            }), /* @__PURE__ */ import_react22.default.createElement("h3", {
                className: "text-lg font-semibold"
            }, "Bulk Directory Upload"), /* @__PURE__ */ import_react22.default.createElement("p", {
                className: "text-sm text-gray-600"
            }, "Upload a spreadsheet and multiple photos from a directory"))), /* @__PURE__ */ import_react22.default.createElement("div", {
                className: "p-6 bg-[#F8FAF9] rounded-xl hover:bg-[#E9EFED] cursor-pointer transition-colors",
                onClick: function() {
                ...
                className: "flex flex-col items-center text-center space-y-4"
            }, /* @__PURE__ */ import_react22.default.createElement(import_lucide_react17.Upload, {
                className: "w-12 h-12 text-[#4B7163]"
            }), /* @__PURE__ */ import_react22.default.createElement("h3", {
                className: "text-lg font-semibold"
            }, "Individual Upload"), /* @__PURE__ */ import_react22.default.createElement("p", {
                className: "text-sm text-gray-600"
            }, "Upload photos and add descriptions one by one")))) : uploadMethod === "bulk" ? /* @__PURE__ */ import_react22.default.createElement("div", {
                className: "space-y-6"
            }, /* @__PURE__ */ import_react22.default.createElement("div", {
                className: "p-6 bg-[#F8FAF9] rounded-xl"
            }, /* @__PURE__ */ import_react22.default.createElement("h3", {
                className: "text-lg font-semibold mb-4"
            }, "Upload Spreadsheet"), /* @__PURE__ */ import_react22.default.createElement("input", {
                type: "file",
                accept: ".xls,.xlsx,.csv",
                onChange: handleSpreadsheetUpload,
                className: "w-full"
            }), spreadsheet && /* @__PURE__ */ import_react22.default.createElement("p", {
                className: "text-sm text-gray-500 mt-2"
            }, "Uploaded: ", spreadsheet.name)), /* @__PURE__ */ import_react22.default.createElement("div", {
                className: "p-6 bg-[#F8FAF9] rounded-xl"
            }, /* @__PURE__ */ import_react22.default.createElement("h3", {
                className: "text-lg font-semibold mb-4"
            }, "Upload Photos"), /* @__PURE__ */ import_react22.default.createElement("input", {
                type: "file",
                accept: "image/*",
                multiple: true,
                onChange: handleBulkPhotoUpload,
                className: "w-full"
            }), bulkPhotos && /* @__PURE__ */ import_react22.default.createElement("p", {
                className: "text-sm text-gray-500 mt-2"
            }, bulkPhotos.length, " photos selected")), /* @__PURE__ */ import_react22.default.createElement(CustomButton, {
                variant: "secondary",
                onClick: function() {
                    return setUploadMethod(null);
                },
                className: "mt-4"
            }, "Change Upload Method")) : /* @__PURE__ */ import_react22.default.createElement("div", {
                className: "space-y-6"
            }, /* @__PURE__ */ import_react22.default.createElement(ImageUpload, {
                onUpload: function(photos) {
                    console.log("Individual photos uploaded:", photos);
                },
                maxFiles: 10
            }), /* @__PURE__ */ import_react22.default.createElement(CustomButton, {
                variant: "secondary",
                onClick: function() {
                    return setUploadMethod(null);
                },
            ...
            return /* @__PURE__ */ import_react22.default.createElement("div", {
                ...
                className: "font-rockwell text-lg text-[#4B7163] mb-4"
            }, "Schedule Drop-off"), /* @__PURE__ */ import_react22.default.createElement("div", {
                className: "grid grid-cols-1 md:grid-cols-2 gap-4"
            }, /* @__PURE__ */ import_react22.default.createElement(FormInput, {
                type: "date",
                label: "Drop-off Date",
                value: dropOffDate,
                min: /* @__PURE__ */ new Date().toISOString().split("T")[0],
            ...
            return /* @__PURE__ */ import_react22.default.createElement("div", {
                ...
                className: "bg-[#F8FAF9] rounded-xl p-6 text-center"
            }, /* @__PURE__ */ import_react22.default.createElement(import_lucide_react17.CheckCircle2, {
                className: "w-16 h-16 text-[#4B7163] mx-auto mb-4"
            }), /* @__PURE__ */ import_react22.default.createElement("h3", {
                className: "font-rockwell text-2xl text-[#4B7163] mb-4"
            }, "Thank You for Your Request!"), /* @__PURE__ */ import_react22.default.createElement("p", {
                className: "text-[#5A7C6F] mb-6"
            }, "We'll review your request and get back to you shortly. Thank you for being a sustainable partner!")));
        }
        return null;
    };
    return /* @__PURE__ */ import_react22.default.createElement(PickupRequestForm, {
...
var LogisticsCalendar = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react23.useState)(false), 2), showDetails = _ref[0], setShowDetails = _ref[1];
    ...
    return /* @__PURE__ */ import_react23.default.createElement("div", {
        ...
        className: "space-y-6"
    }, !showDetails ? /* @__PURE__ */ import_react23.default.createElement(import_react23.default.Fragment, null, /* @__PURE__ */ import_react23.default.createElement("div", null, /* @__PURE__ */ import_react23.default.createElement("h3", {
        className: "font-rockwell text-xl text-[#4B7163] mb-4 flex items-center gap-2"
    }, /* @__PURE__ */ import_react23.default.createElement(import_lucide_react18.Calendar, {
        className: "w-5 h-5"
    }), "Select Date"), /* @__PURE__ */ import_react23.default.createElement("div", {
        className: "relative"
    }, /* @__PURE__ */ import_react23.default.createElement(FormInput, {
        type: "date",
        label: "Date",
        value: selectedDate || "",
        min: /* @__PURE__ */ new Date().toISOString().split("T")[0],
    ...
    }), /* @__PURE__ */ import_react23.default.createElement("datalist", {
        id: "available-dates"
    }, availableDates.map(function(date) {
        return /* @__PURE__ */ import_react23.default.createElement("option", {
            key: date,
            value: date
        });
    })), !availableDates.includes(selectedDate || "") && selectedDate && /* @__PURE__ */ import_react23.default.createElement("p", {
        ...
        className: "font-rockwell text-xl text-[#4B7163] mb-4 flex items-center gap-2"
    }, /* @__PURE__ */ import_react23.default.createElement(import_lucide_react18.Clock, {
        className: "w-5 h-5"
    }), "Available Times"), /* @__PURE__ */ import_react23.default.createElement("div", {
        className: "grid grid-cols-1 md:grid-cols-3 gap-4"
        ...
        }, slot.time), /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "text-sm opacity-75"
        }, slot.availableDrivers, " drivers available")), /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "flex justify-between text-sm"
        }, /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "flex flex-col items-center",
            title: "Number of pickups"
        }, /* @__PURE__ */ import_react23.default.createElement(import_lucide_react18.Truck, {
            className: "w-5 h-5 mb-1"
        }), /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "text-lg font-bold"
        }, slot.pickupCount)), /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "flex flex-col items-center",
            title: "Number of drop-offs"
        }, /* @__PURE__ */ import_react23.default.createElement(import_lucide_react18.Package, {
            className: "w-5 h-5 mb-1"
        }), /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "text-lg font-bold"
        }, slot.dropoffCount)))));
        ...
        className: "font-semibold text-[#4B7163] mb-2"
    }, "Daily Summary"), /* @__PURE__ */ import_react23.default.createElement("div", {
        className: "grid grid-cols-2 gap-4 text-sm"
    }, /* @__PURE__ */ import_react23.default.createElement("div", null, "Total Pickups: ", dayDetails[0].totalPickups), /* @__PURE__ */ import_react23.default.createElement("div", null, "Total Drop-offs: ", dayDetails[0].totalDropoffs), /* @__PURE__ */ import_react23.default.createElement("div", null, "Available Drivers: ", dayDetails[0].availableDrivers))))) : /* @__PURE__ */ import_react23.default.createElement("div", {
        className: "space-y-6"
    }, /* @__PURE__ */ import_react23.default.createElement("div", {
        className: "flex items-center justify-between"
    }, /* @__PURE__ */ import_react23.default.createElement("h3", {
        className: "font-rockwell text-xl text-[#4B7163] flex items-center gap-2"
    }, /* @__PURE__ */ import_react23.default.createElement(import_lucide_react18.Clock, {
        className: "w-5 h-5"
    }), selectedDate, " at ", selectedTime), /* @__PURE__ */ import_react23.default.createElement(CustomButton, {
        variant: "secondary",
        onClick: function() {
        ...
        className: "w-4 h-4"
    }), "Back to Calendar")), /* @__PURE__ */ import_react23.default.createElement("div", {
        className: "space-y-6"
    }, /* @__PURE__ */ import_react23.default.createElement("div", {
    ...
    }, "Pickups (", selectedTimeSlot === null || selectedTimeSlot === void 0 ? void 0 : selectedTimeSlot.pickupCount, ")"))), /* @__PURE__ */ import_react23.default.createElement("div", {
        className: "space-y-4"
        ...
        }, pickup.customerName)), /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "flex items-center gap-2 text-sm text-[#5A7C6F] mb-2"
        }, /* @__PURE__ */ import_react23.default.createElement(import_lucide_react18.MapPin, {
            className: "w-4 h-4"
        }), pickup.address), /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "flex gap-2 overflow-x-auto pb-2"
        }, pickup.items.map(function(item) {
            return /* @__PURE__ */ import_react23.default.createElement("img", {
                key: item.id,
                src: item.imageUrl,
                alt: item.name,
                className: "w-16 h-16 object-cover rounded",
        ...
        className: "font-semibold text-[#4B7163]"
    }, "Drop-offs (", selectedTimeSlot === null || selectedTimeSlot === void 0 ? void 0 : selectedTimeSlot.dropoffCount, ")"))), /* @__PURE__ */ import_react23.default.createElement("div", {
        className: "space-y-4"
        ...
        return /* @__PURE__ */ import_react23.default.createElement("div", {
            ...
            className: "font-semibold"
        }, dropoff.customerName)), /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "flex items-center gap-2 text-sm text-[#5A7C6F] mb-2"
        }, /* @__PURE__ */ import_react23.default.createElement(import_lucide_react18.MapPin, {
            className: "w-4 h-4"
        }), dropoff.address), /* @__PURE__ */ import_react23.default.createElement("div", {
            className: "flex gap-2 overflow-x-auto pb-2"
...
var ProcessingQueue = function(param) {
    ...
    return /* @__PURE__ */ import_react24.default.createElement("div", {
        ...
        className: "font-rockwell text-2xl text-[#4B7163] mb-6"
    }, "Items Awaiting Processing (", items.length, " ", items.length === 1 ? "item" : "items", ")"), items.length === 0 ? /* @__PURE__ */ import_react24.default.createElement("div", {
        className: "text-center py-8 text-gray-500 font-sourceSans"
    }, "No items awaiting processing") : /* @__PURE__ */ import_react24.default.createElement("div", {
        ...
        return /* @__PURE__ */ import_react24.default.createElement("div", {
            ...
            className: "flex justify-between items-start gap-2"
        }, /* @__PURE__ */ import_react24.default.createElement("div", null, /* @__PURE__ */ import_react24.default.createElement("h3", {
            className: "font-rockwell text-lg text-[#4B7163] mb-1"
        }, "Product ID: ", item.productId), /* @__PURE__ */ import_react24.default.createElement("p", {
            className: "text-sm text-gray-600 font-sourceSans"
        }, item.pickupDescription)), /* @__PURE__ */ import_react24.default.createElement(CustomButton, {
            onClick: function() {
                return onSelectItem(item.id);
            },
            variant: "secondary",
            className: "flex items-center gap-2"
        }, "Process ", /* @__PURE__ */ import_react24.default.createElement(import_lucide_react19.ArrowRight, {
            className: "h-4 w-4"
        }))), /* @__PURE__ */ import_react24.default.createElement("div", {
            className: "flex justify-between items-center mt-4"
        }, /* @__PURE__ */ import_react24.default.createElement("span", {
            className: "text-sm text-gray-500"
        }, "From: ", item.customerName), /* @__PURE__ */ import_react24.default.createElement("span", {
            className: "text-sm text-gray-500"
...
var DriverPickupWorkflow = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react25.useState)(null), 2), selectedRequest = _ref[0], setSelectedRequest = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react25.useState)(null), 2), selectedDate = _ref1[0], setSelectedDate = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react25.useState)(false), 2), isMessagesExpanded = _ref2[0], setIsMessagesExpanded = _ref2[1];
    var _ref3 = _sliced_to_array((0, import_react25.useState)(false), 2), isMapModalOpen = _ref3[0], setIsMapModalOpen = _ref3[1];
    ...
    if (!selectedRequest) {
        return /* @__PURE__ */ import_react25.default.createElement("div", {
            className: cn("bg-white rounded-2xl border-2 border-[#4B7163] p-6", "flex flex-col", className)
        }, /* @__PURE__ */ import_react25.default.createElement("h2", {
            className: "font-rockwell text-2xl text-[#4B7163] mb-6"
        }, "Pickups (", filteredRequests.length, ")"), /* @__PURE__ */ import_react25.default.createElement("div", {
            className: "mb-4"
        }, /* @__PURE__ */ import_react25.default.createElement(FormDropdown, {
            ...
            return /* @__PURE__ */ import_react25.default.createElement("div", {
                ...
                className: "font-rockwell text-lg text-[#4B7163]"
            }, request.customerName), /* @__PURE__ */ import_react25.default.createElement("div", {
                className: "flex items-center gap-2 text-sm text-[#5A7C6F] mt-1"
            }, /* @__PURE__ */ import_react25.default.createElement(import_lucide_react20.MapPin, {
                className: "h-4 w-4"
            }), /* @__PURE__ */ import_react25.default.createElement("span", null, request.address)), /* @__PURE__ */ import_react25.default.createElement("div", {
                className: "flex items-center gap-2 text-sm text-[#5A7C6F] mt-1"
            }, /* @__PURE__ */ import_react25.default.createElement(import_lucide_react20.Calendar, {
                className: "h-4 w-4"
            }), /* @__PURE__ */ import_react25.default.createElement("span", null, request.pickupDate ? new Date(request.pickupDate).toLocaleDateString() : "No date set"))), /* @__PURE__ */ import_react25.default.createElement(import_lucide_react20.ChevronRight, {
    ...
    return /* @__PURE__ */ import_react25.default.createElement("div", {
    ...
    }, /* @__PURE__ */ import_react25.default.createElement(CustomButton, {
        variant: "secondary",
        onClick: function() {
            return setSelectedRequest(null);
        },
        className: "mb-4"
    }, "\u2190 Back to List"), /* @__PURE__ */ import_react25.default.createElement("div", {
        className: "bg-white rounded-2xl border-2 border-[#4B7163] p-6 space-y-6"
    }, /* @__PURE__ */ import_react25.default.createElement("h2", {
        className: "font-rockwell text-2xl text-[#4B7163] mb-4"
    }, "Pickup Details"), /* @__PURE__ */ import_react25.default.createElement("div", {
        className: "mb-6"
    }, /* @__PURE__ */ import_react25.default.createElement("h3", {
        className: "font-rockwell text-lg text-[#4B7163] mb-2"
    }, "Customer Information"), /* @__PURE__ */ import_react25.default.createElement("div", {
        className: "bg-[#F8FAF9] p-4 rounded-xl"
    }, /* @__PURE__ */ import_react25.default.createElement("p", {
        className: "text-[#5A7C6F] mb-2"
    }, /* @__PURE__ */ import_react25.default.createElement("strong", null, "Name:"), " ", selectedRequest.customerName), /* @__PURE__ */ import_react25.default.createElement("p", {
        className: "text-[#5A7C6F] mb-2"
    }, /* @__PURE__ */ import_react25.default.createElement("strong", null, "Contact:"), " ", selectedRequest.customerEmail || selectedRequest.customerPhone), /* @__PURE__ */ import_react25.default.createElement("div", {
        ...
        className: "underline"
    }, selectedRequest.address)), /* @__PURE__ */ import_react25.default.createElement("div", {
        className: "flex items-center gap-2 text-[#5A7C6F] mt-2"
    }, /* @__PURE__ */ import_react25.default.createElement(import_lucide_react20.Calendar, {
        className: "h-4 w-4"
    }), /* @__PURE__ */ import_react25.default.createElement("p", null, new Date(selectedRequest.pickupDate || "").toLocaleDateString())))), isMapModalOpen && /* @__PURE__ */ import_react25.default.createElement(MapModal, {
        ...
        className: "font-rockwell text-lg text-[#4B7163] mb-2"
    }, "Items"), /* @__PURE__ */ import_react25.default.createElement("div", {
        ...
        return /* @__PURE__ */ import_react25.default.createElement("div", {
            ...
            className: "relative h-full mx-8"
        }, /* @__PURE__ */ import_react25.default.createElement(SwipeCard, {
            ...
            className: "bg-[#F8FAF9] p-4 rounded-xl h-full overflow-y-auto"
        }, /* @__PURE__ */ import_react25.default.createElement("h4", {
            className: "font-semibold text-[#4B7163] mb-2"
        }, item.name), /* @__PURE__ */ import_react25.default.createElement("p", {
            className: "text-sm text-[#5A7C6F] mb-2"
        }, item.description), /* @__PURE__ */ import_react25.default.createElement("div", {
            className: "flex items-center gap-2"
        ...
        className: "flex items-center gap-1"
    }, /* @__PURE__ */ import_react25.default.createElement(import_lucide_react20.X, {
        className: "h-4 w-4 text-red-500"
    }), " Swipe left if not picking up item"), /* @__PURE__ */ import_react25.default.createElement("div", {
        className: "flex items-center gap-1"
    }, /* @__PURE__ */ import_react25.default.createElement(import_lucide_react20.Check, {
        className: "h-4 w-4 text-green-500"
    }), " Swipe right if you have picked up the item"))), /* @__PURE__ */ import_react25.default.createElement("div", {
        className: "mt-6"
    }, /* @__PURE__ */ import_react25.default.createElement(MessageThread, {
...
var DropoffRequestManager = function(param) {
    ...
    var _ref = _sliced_to_array((0, import_react26.useState)(0), 2), currentRequestIndex = _ref[0], setCurrentRequestIndex = _ref[1];
    var _ref1 = _sliced_to_array((0, import_react26.useState)("name"), 2), sortField = _ref1[0], setSortField = _ref1[1];
    var _ref2 = _sliced_to_array((0, import_react26.useState)("asc"), 2), sortDirection = _ref2[0], setSortDirection = _ref2[1];
    ...
    return /* @__PURE__ */ import_react26.default.createElement("div", {
    ...
    }, /* @__PURE__ */ import_react26.default.createElement("h2", {
        className: "text-2xl font-rockwell text-[#4B7163]"
    }, "Partner Drop-off Requests"), /* @__PURE__ */ import_react26.default.createElement("div", {
        className: "flex gap-2"
    }, /* @__PURE__ */ import_react26.default.createElement(CustomButton, {
        onClick: function() {
            return setCurrentRequestIndex(function(prev) {
                return Math.max(0, prev - 1);
            });
        ...
        disabled: currentRequestIndex === 0
    }, "Previous"), /* @__PURE__ */ import_react26.default.createElement(CustomButton, {
        onClick: function() {
            return setCurrentRequestIndex(function(prev) {
    ...
    }, "Next"))), /* @__PURE__ */ import_react26.default.createElement("div", {
        className: "bg-[#F8FAF9] p-4 rounded-lg"
    }, /* @__PURE__ */ import_react26.default.createElement("h3", {
        className: "font-semibold text-[#4B7163] mb-2"
    }, "Partner Information"), /* @__PURE__ */ import_react26.default.createElement("div", {
        className: "grid grid-cols-2 gap-4"
    }, /* @__PURE__ */ import_react26.default.createElement("div", null, /* @__PURE__ */ import_react26.default.createElement("p", {
        className: "text-sm text-gray-600"
    }, "Name"), /* @__PURE__ */ import_react26.default.createElement("p", {
        className: "font-medium"
    }, currentRequest.partnerName)), /* @__PURE__ */ import_react26.default.createElement("div", null, /* @__PURE__ */ import_react26.default.createElement("p", {
        className: "text-sm text-gray-600"
    }, "Email"), /* @__PURE__ */ import_react26.default.createElement("p", {
        className: "font-medium"
    }, currentRequest.partnerEmail)), /* @__PURE__ */ import_react26.default.createElement("div", null, /* @__PURE__ */ import_react26.default.createElement("p", {
        className: "text-sm text-gray-600"
    }, "Phone"), /* @__PURE__ */ import_react26.default.createElement("p", {
        className: "font-medium"
    }, currentRequest.partnerPhone)), /* @__PURE__ */ import_react26.default.createElement("div", null, /* @__PURE__ */ import_react26.default.createElement("p", {
        className: "text-sm text-gray-600"
    }, "Scheduled Date"), /* @__PURE__ */ import_react26.default.createElement("p", {
        className: "font-medium"
    }, currentRequest.scheduledDate)))), /* @__PURE__ */ import_react26.default.createElement("div", {
    ...
    }, /* @__PURE__ */ import_react26.default.createElement(import_lucide_react21.Package, {
        className: "w-5 h-5"
    }), "Items (", currentRequest === null || currentRequest === void 0 ? void 0 : currentRequest.items.length, ")"), /* @__PURE__ */ import_react26.default.createElement("div", {
        className: "flex gap-2"
    }, /* @__PURE__ */ import_react26.default.createElement(CustomButton, {
        variant: "secondary",
        onClick: function() {
        ...
        className: "flex items-center gap-2"
    }, /* @__PURE__ */ import_react26.default.createElement(import_lucide_react21.FileSpreadsheet, {
        className: "w-4 h-4"
    }), "Export"))), /* @__PURE__ */ import_react26.default.createElement("div", {
        className: "overflow-x-auto"
    }, /* @__PURE__ */ import_react26.default.createElement("table", {
        className: "w-full"
    }, /* @__PURE__ */ import_react26.default.createElement("thead", {
        className: "bg-[#F8FAF9]"
    }, /* @__PURE__ */ import_react26.default.createElement("tr", null, /* @__PURE__ */ import_react26.default.createElement("th", {
        className: "p-2 text-left"
    }, "Image"), /* @__PURE__ */ import_react26.default.createElement("th", {
        className: "p-2 text-left"
    }, "Name"), /* @__PURE__ */ import_react26.default.createElement("th", {
        className: "p-2 text-left"
    }, "Description"), /* @__PURE__ */ import_react26.default.createElement("th", {
        className: "p-2 text-left"
    }, "Category"), /* @__PURE__ */ import_react26.default.createElement("th", {
        className: "p-2 text-left"
    }, "Condition"), /* @__PURE__ */ import_react26.default.createElement("th", {
        className: "p-2 text-right"
    }, "Est. Value"), /* @__PURE__ */ import_react26.default.createElement("th", {
        className: "p-2 text-center"
    }, "Quantity"))), /* @__PURE__ */ import_react26.default.createElement("tbody", null, sortedItems.map(function(item) {
        return /* @__PURE__ */ import_react26.default.createElement("tr", {
            key: item.id,
            className: "border-t border-gray-200"
        }, /* @__PURE__ */ import_react26.default.createElement("td", {
            className: "p-2"
            ...
            className: "p-2"
        }, item.name), /* @__PURE__ */ import_react26.default.createElement("td", {
            className: "p-2"
        }, item.description), /* @__PURE__ */ import_react26.default.createElement("td", {
            className: "p-2"
        }, item.category), /* @__PURE__ */ import_react26.default.createElement("td", {
            className: "p-2"
        }, item.condition), /* @__PURE__ */ import_react26.default.createElement("td", {
            className: "p-2 text-right"
        }, "$", item.estimatedValue), /* @__PURE__ */ import_react26.default.createElement("td", {
            className: "p-2"
        }, /* @__PURE__ */ import_react26.default.createElement("div", {
        ...
        }, /* @__PURE__ */ import_react26.default.createElement(import_lucide_react21.Minus, {
            className: "w-4 h-4"
        })), /* @__PURE__ */ import_react26.default.createElement("span", {
            className: "w-8 text-center"
        }, item.quantity), /* @__PURE__ */ import_react26.default.createElement("button", {
            onClick: function() {
                return onUpdateQuantity(currentRequest.id, item.id, item.quantity + 1);
            },
            className: "p-1 hover:bg-gray-100 rounded"
        }, /* @__PURE__ */ import_react26.default.createElement(import_lucide_react21.Plus, {
            className: "w-4 h-4"
        })))));
    })))))), /* @__PURE__ */ import_react26.default.createElement(MessageThread, {
...
var InventoryProcessingManager = function(param) {
    var items = param.items, onUpdateDetails = param.onUpdateDetails, onUpdateStatus = param.onUpdateStatus, onSaveDraft = param.onSaveDraft, className = param.className;
    var _ref = _sliced_to_array((0, import_react27.useState)(null), 2), selectedItemId = _ref[0], setSelectedItemId = _ref[1];
    ...
    if (selectedItemId) {
        ...
        }, "\u2190 Back to Queue"), /* @__PURE__ */ import_react27.default.createElement(ListingWorkflow, {
    ...
    return /* @__PURE__ */ import_react27.default.createElement(ProcessingQueue, {
        items: items,
...
var SearchInput = import_react28.default.forwardRef(function(param, ref) {
    ...
    }, /* @__PURE__ */ import_react28.default.createElement(FormInput, {
        ref: ref,
        label: "Search",
        value: value,
        onChange: onChange,
    ...
    }), /* @__PURE__ */ import_react28.default.createElement(import_lucide_react22.Search, {
        className: "absolute left-3 top-[34px] w-4 h-4 text-[#5A7C6F]/60",
        "aria-hidden": "true"
    })), /* @__PURE__ */ import_react28.default.createElement(CustomButton, {
        variant: "secondary",
        onClick: onFilter,
        className: "flex items-center gap-2 h-[42px] mt-6"
    }, /* @__PURE__ */ import_react28.default.createElement(import_lucide_react22.Filter, {
        className: "w-4 h-4"
    }), "Filter"), /* @__PURE__ */ import_react28.default.createElement(CustomButton, {
        variant: "primary",
        onClick: onSearch,
        className: "flex items-center gap-2 h-[42px] mt-6"
    }, /* @__PURE__ */ import_react28.default.createElement(import_lucide_react22.Search, {
...
var SheetContent = React33.forwardRef(function(_param, ref) {
    ...
    }, /* @__PURE__ */ React33.createElement(import_lucide_react23.X, {
        className: "h-4 w-4"
...
var Header = function(param) {
    ...
    return /* @__PURE__ */ import_react29.default.createElement("header", {
    ...
    }, logo && /* @__PURE__ */ import_react29.default.createElement("a", {
        href: logo.href,
        className: "flex items-center cursor-pointer"
    }, /* @__PURE__ */ import_react29.default.createElement(import_image.default, {
        src: logo.src,
        alt: logo.alt,
    ...
    }, /* @__PURE__ */ import_react29.default.createElement(Sheet, null, /* @__PURE__ */ import_react29.default.createElement(SheetTrigger, {
        asChild: true
    }, /* @__PURE__ */ import_react29.default.createElement(Button, {
        variant: "ghost",
        size: "icon",
        className: "text-white hover:bg-[#5a8575]"
    }, /* @__PURE__ */ import_react29.default.createElement(import_lucide_react24.Menu, {
        className: "h-6 w-6"
    }))), /* @__PURE__ */ import_react29.default.createElement(SheetContent, {
        side: "right",
        className: "w-[80%] sm:w-[400px] bg-[#4B7163] border-l-white/20"
    }, /* @__PURE__ */ import_react29.default.createElement("nav", {
        className: "flex flex-col space-y-4 mt-8"
    }, menuItems.map(function(item) {
        return /* @__PURE__ */ import_react29.default.createElement("a", {
            key: item.label,
            href: item.href,
...
0 && (module.exports = {
    BulkPartnerPickupRequestForm: BulkPartnerPickupRequestForm,
    Button: Button,
    Card: Card,
    CustomButton: CustomButton,
    DriverPickupWorkflow: DriverPickupWorkflow,
    DropoffRequestManager: DropoffRequestManager,
    Footer: Footer,
    ...
    Modal: Modal,
    Page: Page,
    PartnerPickupRequestForm: PartnerPickupRequestForm,
